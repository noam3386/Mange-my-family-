    ...
    try {
      ...
      if (result.isNewUser) {
        ...
        navigate('/register-google', {
          state: { uid: result.uid, displayName: result.displayName, email: result.email },
        })
      } else {
        navigate('/')
      }
      ...
      if (code !== 'auth/popup-closed-by-user') {
        setError('שגיאה בכניסה עם Google, נסו שנית')
      }
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 text-slate-700 font-semibold py-3 px-4 rounded-2xl shadow-sm active:scale-95 transition-all mb-4 hover:border-slate-300"
        >
